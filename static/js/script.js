    ...
    for (i = 0; i < models.length; i++)
    {
        ...
        xhr[i].onreadystatechange = function () {
            if (this.readyState === 4 && this.status === 200) {
                ...
                table.innerHTML= "<tr><th>" + data.nnModel + "</th></tr><tr><th>Prediction</th><th>Confidence Percentage</th></tr><tr><td>"+ data.clsName1 +"</td><td>" + data.percent1 +"</td></tr><tr><td>"+ data.clsName2 +"</td><td>"+ data.percent2 +"</td></tr><tr><td>"+ data.clsName3 +"</td><td>"+ data.percent3 +"</td></tr>";
